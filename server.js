...
// Сторінка інформації про бригаду
app.get('/brigade', (req, res) => {
    res.render('brigade', {
        brigade: {
            name: 'Бригада №28',
            group: 'ІС-34',
            members: ['Костя Ткачов', 'Марія Зозуля', 'Коваленко Богдан'],
            description: 'Наша команда працює над веб-застосунками та тестуванням програмного забезпечення.'
        }
    });
});
